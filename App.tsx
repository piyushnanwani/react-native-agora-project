...
const App = () => {
  ...
  const title = 'WhatsApp Clone - React Native';
  // Replaces <your appKey> with your app key.
  const appKey = '611355963#1562506';
  // Replaces <your userId> with your user ID.
  const [username, setUsername] = React.useState('piyush');
  // Replaces <your agoraToken> with your Agora token.
  const [chatToken, setChatToken] = React.useState(
    '007eJxTYJg95eGTr9uvtfr/MVrWdf7vy4f2TSbnWyMsLh4QlThmHxytwGBkkGSabGGZbJZqZGCSkmhhkWaUaGiaaGqWkmycbJGaymnkk9EQyMjw/PJOZkYGVgZGIATxVRhSEg3NEy3MDHRNLEyTdQ0N0wx0Ey3SzHWNjC3TDCwNk0xSjEwA6ncqLg==',
  );
      ...
      let msgListener = {
        onMessagesReceived(messages) {
          for (let index = 0; index < messages.length; index++) {
            rollLog('received message is : ' + messages[index]?.body?.content  );
          }
        },
